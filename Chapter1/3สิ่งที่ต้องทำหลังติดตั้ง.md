...
ไปที่เมนู **Preferance** &gt; **Raspberry Pi Configuration** เลือก Tab** Localisation** กดปุ่ม **Set Timezone... **แล้วเปลี่ยน Area เป็น **Asia** และเปลี่ยน Location เป็น **Bangkok **
